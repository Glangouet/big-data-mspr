...
CREATE TABLE `mouvement_stock` (
  ...
  PRIMARY KEY (`NO_MOUVEMENT`),
  KEY `FK_MOUVEMEN_GENERER_PRODUIT` (`CODE_PRODUIT`),
  CONSTRAINT `FK_MOUVEMEN_GENERER_PRODUIT` FOREIGN KEY (`CODE_PRODUIT`) REFERENCES `produit` (`code_produit`)
